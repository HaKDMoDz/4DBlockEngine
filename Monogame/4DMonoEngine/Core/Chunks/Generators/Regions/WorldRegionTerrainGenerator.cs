...
namespace _4DMonoEngine.Core.Chunks.Generators.Regions
{
    internal abstract class WorldRegionTerrainGenerator
    {
        ...
        private readonly Dictionary<Vector2, DepthCacheEntry> m_depthCache; 
        ...
        protected WorldRegionTerrainGenerator(float[] noiseBuffer, string name, IEnumerable<WorldRegionLayer> layers, IEnumerable<WorldRegionParameter> parameters)
        {
            ...
            m_depthCache = new Dictionary<Vector2, DepthCacheEntry>();
        ...
        protected float GetNoise(int x, int y, int z, int offset, float scale)
        {
...
// ReSharper disable once LoopCanBeConvertedToQuery
        ...
        protected DepthCacheEntry GetDepthCache(int x, int z)
        {
        ...
        protected class DepthCacheEntry
        {
            ...
            public float Depth;
            public Vector2 Key;
            public DepthCacheEntry(Vector2 key)
            {
                Key = key;
                LayerIndex = 0;
                Depth = 0;
        ...
        public abstract Block Apply(int upperBound, int worldPositionX, int worldPositionY, int worldPositionZ);
    }
}
