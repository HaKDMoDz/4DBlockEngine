...
{
    public class SavanahGenerator : BiomeGeneratorBase
    {
        protected short m_grass;

        public SavanahGenerator(SimplexNoise noise, BlockDictionary blockDictionary)
            : base(noise, blockDictionary)
        {
            m_grass = blockDictionary.GetBlockIdForName("dry_grass");
        }
