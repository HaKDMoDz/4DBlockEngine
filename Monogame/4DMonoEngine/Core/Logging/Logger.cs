...
namespace _4DMonoEngine.Core.Logging
{
    public class Logger
    {
        public delegate void RouteDelegate(Level level, string logger, string message, Exception exception);
        public string Name { get; protected set; }
        private readonly RouteDelegate m_router;
        ...
        {
            m_router(level, Name, args == null ? message : string.Format(CultureInfo.InvariantCulture, message, args), exception);
        }
    }
}