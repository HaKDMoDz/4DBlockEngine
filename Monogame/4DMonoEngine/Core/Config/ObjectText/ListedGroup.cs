...
{
	/// <summary>
	/// A Group node contained by a List node.
	/// </summary>
	public class ListedGroup : GroupEx, IListedNodeEx
	{
		...
		/// <summary>
		/// Gets the List that contains this ListedGroup.
		/// </summary>
		...
		/// <summary>
		/// Parses a new ListedGroup.
		/// </summary>
		/// <param name="parent">The parent List of this ListedGroup.</param>
		...
		internal ListedGroup(List parent, Token colon, InheritenceList inheritenceList, Token beginBrace, Tokenizer tok,
		                     out Token? out1, out Token? out2)
			: base(parent, colon, inheritenceList, beginBrace, tok)
		{
			_parent = parent;
			...
			// Did we read a comma or semicolon?
			if(t.Text == "," || t.Text == ";")
			{
		...
		/// <summary>
		/// Gets the text that defines this ListedGroup.
		/// </summary>
		...
		/// <summary>
		/// Gets text that defines this ListedGroup excluding superfluous whitespace and comments.
		/// </summary>
		...
		/// <summary>
		/// Writes the text that defines this ListedGroup to the specified TextWriter.
		/// </summary>
		...
		/// <summary>
		/// Formats this ListedGroup using the specified formatter.
		/// </summary>
		...
		/// <summary>
		/// Sets the parent of this ListedGroup.
		/// </summary>
