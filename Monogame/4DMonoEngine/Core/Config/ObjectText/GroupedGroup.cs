...
{
	/// <summary>
	/// A Group node contained by a Group node.
	/// </summary>
	public class GroupedGroup : GroupEx, IGroupedNodeEx
	{
		#region Events

		/// <summary>
		/// Called when this GroupedGroup's name has changed.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the name of this GroupedGroup.
		/// </summary>
		...
		/// <summary>
		/// Gets the Group that contains this GroupedGroup.
		/// </summary>
		...
		/// <summary>
		/// Parses a new GroupedGroup.
		/// </summary>
		/// <param name="parent">The parent group of this GroupedGroup.</param>
		...
		internal GroupedGroup(Group parent, Token name, Token insignificant1, Token equals, Token insignificant2, Token colon,
		...
		/// <summary>
		/// Gets the text that defines this GroupedGroup.
		/// </summary>
		...
		/// <summary>
		/// Gets text that defines this GroupedGroup excluding superfluous whitespace and comments.
		/// </summary>
		...
		/// <summary>
		/// Writes the text that defines this GroupedGroup to the specified TextWriter.
		/// </summary>
		...
		/// <summary>
		/// Formats this GroupedGroup using the specified formatter.
		/// </summary>
		...
		/// <summary>
		/// Sets the parent of this GroupedGroup.
		/// </summary>
