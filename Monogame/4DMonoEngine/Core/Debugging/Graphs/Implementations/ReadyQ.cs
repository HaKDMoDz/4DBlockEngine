...
namespace _4DMonoEngine.Core.Debugging.Graphs.Implementations.ChunkGraphs
{
    public class ReadyQ: DebugGraph
    {
        ...
        {
            GraphValues.Add(m_statistics.ReadyQueue);
            ...
            m_currentValue = m_statistics.ReadyQueue;
        ...
        {
            m_spriteBatch.DrawString(m_spriteFont, "readyQ:" + m_currentValue, new Vector2(Bounds.Left, Bounds.Bottom), Color.White);
