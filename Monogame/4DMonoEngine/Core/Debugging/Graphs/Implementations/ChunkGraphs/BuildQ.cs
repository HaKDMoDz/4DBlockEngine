...
namespace _4DMonoEngine.Core.Debugging.Graphs.Implementations.ChunkGraphs
{
    public class BuildQ: DebugGraph
    {
        ...
        {
            GraphValues.Add(m_statistics.BuildQueue);
            ...
            m_currentValue = m_statistics.BuildQueue;
        ...
        {
            m_spriteBatch.DrawString(m_spriteFont, "buildQ:" + m_currentValue, new Vector2(Bounds.Left, Bounds.Bottom), Color.White);
