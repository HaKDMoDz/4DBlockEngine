...
namespace _4DMonoEngine.Core.Debugging.Graphs.Implementations.ChunkGraphs
{
    public class LightenQ: DebugGraph
    {
        ...
        {
            GraphValues.Add(m_statistics.LightenQueue);
            ...
            m_currentValue = m_statistics.LightenQueue;
        ...
        {
            m_spriteBatch.DrawString(m_spriteFont, "lightenQ:" + m_currentValue, new Vector2(Bounds.Left, Bounds.Bottom), Color.White);
