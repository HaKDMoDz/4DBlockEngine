...
namespace _4DMonoEngine.Core.Debugging.Graphs.Implementations.ChunkGraphs
{
    public class RemoveQ: DebugGraph
    {
        ...
        {
            GraphValues.Add(m_statistics.RemovalQueue);
            ...
            m_currentValue = m_statistics.RemovalQueue;
        ...
        {
            m_spriteBatch.DrawString(m_spriteFont, "removeQ:" + m_currentValue, new Vector2(Bounds.Left, Bounds.Bottom), Color.White);
