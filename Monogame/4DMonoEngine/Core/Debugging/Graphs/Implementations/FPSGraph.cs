...
namespace _4DMonoEngine.Core.Debugging.Graphs.Implementations
{
    public class FpsGraph:DebugGraph
    {
        ...
        {
            GraphValues.Add(m_statistics.Fps);
            ...
            m_currentValue = m_statistics.Fps;
        ...
        {
            m_spriteBatch.DrawString(m_spriteFont, "fps:" + m_currentValue, new Vector2(Bounds.Left, Bounds.Bottom), Color.White);
